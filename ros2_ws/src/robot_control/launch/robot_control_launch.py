...
def generate_launch_description():
    ...
    effective_baud_rate = PythonExpression([
        "'", legacy_baudrate, "' if '", legacy_baudrate, "' else '", baud_rate, "'"
    ])
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('camera_url', default_value='http://192.168.1.153/stream'),
        ...
        DeclareLaunchArgument('telemetry_topic', default_value='robot_telemetry'),
